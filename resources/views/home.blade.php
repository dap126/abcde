    ...
    <div class="space-y-6">
      ...
      <!-- Example Post -->
        <div class="bg-white p-5 rounded-xl shadow">
          ...
          <div class="text-sm text-gray-400 mt-2">Posted by {{ $post->user->name }} - {{ $post->created_at->format('d F Y') }}</div>
